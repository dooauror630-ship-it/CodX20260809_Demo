...
export async function getTradeProfit(farmId: number) { return (await apiClient.get<Response<{ items: import("@/types/trade").TradeProfit[] }>>("/trade-profit", { params: { farmId } })).data.data.items; }
